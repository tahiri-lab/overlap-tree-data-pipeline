...
# -*- coding: utf-8 -*-
"""
Construct overlapping pruned phylogenetic trees from a single base tree.
...
YAML example (minimal):
    ...
    # Optional noise (applied after pruning each tree)
        ...
        if ok:
            ...
            for r in removable:
                ...
                if ok:
                    ...
                    break
            if not swapped:
                # last resort: accept addition (relaxes overlap); will be reported
...
def main():
    ap = argparse.ArgumentParser(description="Construct overlapping pruned trees from a base tree.")
